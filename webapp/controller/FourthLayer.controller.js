sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("scm.ctc.dashboard.scmctcdashboard.controller.FourthLayer", {
        formatter: Formatter,
        onInit: function () {
            ...
            this.getRouter().getRoute("fourthlayer").attachPatternMatched(this._onPatternMatched, this);
            self = this;
        ...
        loadinframeModel: function () {
            ...
            var oHolder = this.getView().byId("_idIFrameFourthLayer");
            ...
            if (sExpline !== "") {
                ...
                oIframeDomRef.src = "https://dubaiexpoiframe.cfapps.eu10.hana.ondemand.com/#warehouse/" + this.getView().getModel("localModel").getProperty("/plantName");
            }
        ...
        getInventoryKPIData: function () {
            var sUrl = "/DUBAIEXPO";
            var aFilter = [];
            var oSelect = "EXPINVTOSALESRATIO,EXPINVTOSALESRATIO3DAYS,EXPINVTOSALESRATIODTD,EXPINVTOSALESRATIOMTD,EXPINVTOSALESRATIOWTD,EXPINVTOSALESRATIOYTD,EXPINVENTORYTURNOVER3DAYS,PRDID,EXPINVENTORYTURNOVERWTD,EXPINVENTORYTURNOVERMTD,EXPINVENTORYTURNOVERYTD,EXPINVENTORYTURNOVER,EXPINVENTORYTURNOVERDTD,EXPINVSALESRATIO,LOCID";
            var sPlantDetail = this.getView().getModel("localModel").getProperty("/plantName");
            //aFilter.push(new sap.ui.model.Filter("PERIODID1", sap.ui.model.FilterOperator.EQ, "2022"));
            aFilter.push(new sap.ui.model.Filter("LOCID", sap.ui.model.FilterOperator.EQ, "3710"));
            ...
            this.getView().getModel().read(sUrl, {
                ...
                filters: aFilter,
                success: (oData, oResponse) => {
                    this.getView().getModel("localModel").setProperty("/InventoryKPIData", oData.results);
                },
                error: (oError) => {
        ...
        fetchGraphData: function () {
            ...
            if (filterParameter === "DTD" || filterParameter === "3DAY" || filterParameter === "WTD" || filterParameter === "MTD") {
                aFilter.push(new sap.ui.model.Filter("PERIODID0_TSTAMP", sap.ui.model.FilterOperator.BT, oFromDate, oToDate));
                oSelect = "PERIODID0_TSTAMP,PRDID,EXPINVENTORYTURNOVER,EXPINVTOSALESRATIO,LOCID";
            }
            if (filterParameter === "YTD") {
                aFilter.push(new sap.ui.model.Filter("PERIODID1_TSTAMP", sap.ui.model.FilterOperator.BT, dOldDate, dCurrentDate));
                oSelect = "PERIODID3_TSTAMP,EXPINVTOSALESRATIOMTD,PRDID,EXPINVENTORYTURNOVERMTD,LOCID";
            }
        ...
        buildGraphData1: function (filterParameter) {
            var newGraphData = []
            var oGraphData = this.getView().getModel("localModel").getProperty("/ChartData");
            var graphPlotField = { EXPINVENTORYTURNOVER: [], EXPINVTOSALESRATIO: [] };
            ...
            oGraphData.forEach((eachGraphData) => {
                ...
                if (filterParameter === "DTD" || filterParameter === "3DAY" || filterParameter === "WTD" || filterParameter === "MTD") {
                    newGraphData.forEach((eachNewData) => {
                        if (eachNewData.PERIODID0_TSTAMP === eachGraphData.PERIODID0_TSTAMP) {
                    ...
                    blankData.PERIODID0_TSTAMP = eachGraphData.PERIODID0_TSTAMP;
                } else if (filterParameter === "YTD") {
                    newGraphData.forEach((eachNewData) => {
                        if (eachNewData.PERIODID1_TSTAMP === eachGraphData.PERIODID1_TSTAMP) {
                            blankData = eachNewData;
                            isNotPresent = false;
                            return true
                        }
                    ...
                    blankData.PERIODID1_TSTAMP = eachGraphData.PERIODID3_TSTAMP;
                }

                if (eachGraphData.PRDID === "FG126") {
                    blankData.FGEXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVER) * 100).toFixed(0);
                    blankData.FGEXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIO) * 100).toFixed(0);
                    if(filterParameter === "YTD"){
                        blankData.FGEXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVERMTD) * 100).toFixed(0);
                        blankData.EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIOMTD) * 100).toFixed(0);
                    }
                    
                    if (eachGraphData.EXPINVENTORYTURNOVER || eachGraphData.EXPINVENTORYTURNOVERMTD) {
                        graphPlotField.EXPINVENTORYTURNOVER.indexOf("FGEXPINVENTORYTURNOVER") === -1 ? graphPlotField.EXPINVENTORYTURNOVER.push("FGEXPINVENTORYTURNOVER") : "";
                    }
                    if (eachGraphData.EXPINVTOSALESRATIO || eachGraphData.EXPINVTOSALESRATIOMTD) {
                        graphPlotField.EXPINVTOSALESRATIO.indexOf("FGEXPINVTOSALESRATIO") === -1 ? graphPlotField.EXPINVTOSALESRATIO.push("FGEXPINVTOSALESRATIO") : "";
                    }
                }
                if (eachGraphData.PRDID === "IBP-100") {
                    blankData.IBP100EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVER) * 100).toFixed(0);
                    blankData.IBP100EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIO) * 100).toFixed(0);
                    if(filterParameter === "YTD"){
                        blankData.IBP100EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVERMTD) * 100).toFixed(0);
                        blankData.IBP100EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIOMTD) * 100).toFixed(0);
                    }
                    
                    if (eachGraphData.EXPINVENTORYTURNOVER || eachGraphData.EXPINVENTORYTURNOVERMTD) {
                        graphPlotField.EXPINVENTORYTURNOVER.indexOf("IBP100EXPINVENTORYTURNOVER") === -1 ? graphPlotField.EXPINVENTORYTURNOVER.push("IBP100EXPINVENTORYTURNOVER") : "";
                    }
                    if (eachGraphData.EXPINVTOSALESRATIO || eachGraphData.EXPINVTOSALESRATIOMTD) {
                        graphPlotField.EXPINVTOSALESRATIO.indexOf("IBP100EXPINVTOSALESRATIO") === -1 ? graphPlotField.EXPINVTOSALESRATIO.push("IBP100EXPINVTOSALESRATIO") : "";
                    }
                }
                if (eachGraphData.PRDID === "IBP-110") {
                    blankData.IBP110EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVER) * 100).toFixed(0);
                    blankData.IBP110EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIO) * 100).toFixed(0);
                    if(filterParameter === "YTD"){
                        blankData.IBP110EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVERMTD) * 100).toFixed(0);
                        blankData.IBP110EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIOMTD) * 100).toFixed(0);
                    }
                    
                    if (eachGraphData.EXPINVENTORYTURNOVER || eachGraphData.EXPINVENTORYTURNOVERMTD) {
                        graphPlotField.EXPINVENTORYTURNOVER.indexOf("IBP110EXPINVENTORYTURNOVER") === -1 ? graphPlotField.EXPINVENTORYTURNOVER.push("IBP110EXPINVENTORYTURNOVER") : "";
                    }
                    if (eachGraphData.EXPINVTOSALESRATIO || eachGraphData.EXPINVTOSALESRATIOMTD) {
                        graphPlotField.EXPINVTOSALESRATIO.indexOf("IBP110EXPINVTOSALESRATIO") === -1 ? graphPlotField.EXPINVTOSALESRATIO.push("IBP110EXPINVTOSALESRATIO") : "";
                    }
                }
                if (eachGraphData.PRDID === "IBP-120") {
                    blankData.IBP120EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVER) * 100).toFixed(0);
                    blankData.IBP120EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIO) * 100).toFixed(0);
                    if(filterParameter === "YTD"){
                        blankData.IBP120EXPINVENTORYTURNOVER = ((eachGraphData.EXPINVENTORYTURNOVERMTD) * 100).toFixed(0);
                        blankData.IBP120EXPINVTOSALESRATIO = ((eachGraphData.EXPINVTOSALESRATIOMTD) * 100).toFixed(0);
                    }
                    
                    if (eachGraphData.EXPINVENTORYTURNOVER || eachGraphData.EXPINVENTORYTURNOVERMTD) {
                        graphPlotField.EXPINVENTORYTURNOVER.indexOf("IBP120EXPINVENTORYTURNOVER") === -1 ? graphPlotField.EXPINVENTORYTURNOVER.push("IBP120EXPINVENTORYTURNOVER") : "";
                    }
                    if (eachGraphData.EXPINVTOSALESRATIO || eachGraphData.EXPINVTOSALESRATIOMTD) {
                        graphPlotField.EXPINVTOSALESRATIO.indexOf("IBP120EXPINVTOSALESRATIO") === -1 ? graphPlotField.EXPINVTOSALESRATIO.push("IBP120EXPINVTOSALESRATIO") : "";
                    }
                }

                var sObtainedDate, oDate;
                if (filterParameter === "DTD") {
                    sObtainedDate = eachGraphData.PERIODID0_TSTAMP
                } else if (filterParameter === "3DAY") {
                    sObtainedDate = eachGraphData.PERIODID0_TSTAMP
                } else if (filterParameter === "WTD") {
                    sObtainedDate = eachGraphData.PERIODID0_TSTAMP
                } else if (filterParameter === "MTD") {
                    sObtainedDate = eachGraphData.PERIODID0_TSTAMP
                } else if (filterParameter === "YTD") {
                    sObtainedDate = eachGraphData.PERIODID3_TSTAMP
                }
                ...
                if (filterParameter === "YTD") {
                    sObtainedDate = eachGraphData.PERIODID3_TSTAMP
                    blankData.sFormattedDate = sObtainedDate.toString().slice(4, 7);
                }

                if (isNotPresent) {
                    if (filterParameter === "YTD") {
                        if (new Date().getMonth() < blankData.PERIODID1_TSTAMP.getMonth()) {
                            return;
                        }
                        if (blankData.EXPINVTOSALESRATIOYTD === "0") {
                            blankData.EXPINVTOSALESRATIOYTD = "99"
                        }
        ...
        plotLineChart1: function () {
            ...
            var oVizFrameARTL = this.byId(sap.ui.core.Fragment.createId("_IDTLLineEffectiveTile", "FL1vizFrameid"));
            ...
            oFieldNames.EXPINVENTORYTURNOVER.forEach(eachName => {
                var oNewMeasures = {
                    name: eachName,
                    value: `{${eachName}}`
                };
            ...
            var feedvalueAxis = new sap.viz.ui5.controls.common.feeds.FeedItem({
                'uid': "valueAxis",
                'type': "Measure",
                'values': oFieldNames.EXPINVENTORYTURNOVER
            }),
        ...
        plotLineChart2: function () {
            ...
            //var oVizFrame = this.getView().byId("vizFrameid");
            var oVizFrameUR = this.byId(sap.ui.core.Fragment.createId("_IDTLLineEffectiveTile", "FLvizFrameid"))
            ...
            var oFieldNames = chartData.getProperty("/graphFieldNames");
            // availableRate: [], qualityRate : [], utilizationRate : []
            oFieldNames.EXPINVTOSALESRATIO.forEach(eachName => {
                var oNewMeasures = {
                    name: eachName,
                    value: `{${eachName}}`
                };
            ...
            var feedvalueAxis = new sap.viz.ui5.controls.common.feeds.FeedItem({
                'uid': "valueAxis",
                'type': "Measure",
                'values': oFieldNames.EXPINVTOSALESRATIO
            }),
        ...
        handlePopoverPress: function (oEvent) {
            ...
            this.getView().getModel().read(sUrl, {
                ...
                filters: aFilter,
                success: (oData, oResponse) => {
                    this.getView().getModel("localModel").setProperty("/selectedPointDataDC", oData.results);
                    var oView = this.getView();
                    var oChart = this.byId(sap.ui.core.Fragment.createId("_IDTLLineEffectiveTile", "FL1vizFrameid"));
                    // create popover
                    if (!this._pPopover) {
                        this._pPopover = Fragment.load({
                            id: oView.getId(),
                            name: "scm.ctc.dashboard.scmctcdashboard.view.fragments.ChartPopoverDC",
                            controller: this
                        }).then(function (oPopover) {
                            oView.addDependent(oPopover);
